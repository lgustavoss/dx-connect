...
- Pré-ticket IA (#808 / #809 / #810): admin envia contexto de ticket, IA devolve análise estruturada (classificação, lacunas, riscos, rascunho de issue); revisão e aprovação humana antes de publicar no GitHub (lote 2)
- Pré-ticket IA (#813 / #814): após aprovação, cria issue no GitHub (template padronizado, idempotente); histórico interno e auditoria das ações; RBAC admin v1
- Pré-ticket IA (#815): métricas de uso/qualidade/custo das análises IA, alertas de degradação e painel de observabilidade na página admin
