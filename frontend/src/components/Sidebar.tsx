...
const icons: Record<string, React.ReactNode> = {
  ...
  atendimento: (
    <svg className="size-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h8M8 14h5m-7 7l-3-3V6a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2H8l-3 3z" />
    </svg>
  ),
  clientes: (
    <svg className="size-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
...
const navStructure: NavItem[] = [
  ...
  { type: 'link', to: '/atendimento', label: 'Atendimento IA', icon: 'atendimento' },
